...
const ToysAll = () => {
    ...
    const handleSearch = () => {
      fetch(`https://edu-ler-toy-server-farjanaakterlaila.vercel.app/search/${searchText}`)
        .then((res) => res.json())
        .then((data) => {
          console.log(data);
          setServices(data);
    ...
    return (
        <div>
          <Helmet><title>EduLerToys/All Toys</title></Helmet>
 <div className="my-jobs-container">
        <h1 className="iteam text-center p-4 ">ALL Toys</h1>
